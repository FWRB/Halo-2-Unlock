...
%define HacksSegmentAddress             0080c000h           ; Virtual address of the .hacks segment
...
;-------------------------------------------------------------
    ...
    _i_dont_agree_start:
            ...
            ; Skip the call.
            times (001B1263h - 001B125Ch) db 90h
