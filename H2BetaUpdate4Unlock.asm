...
%define HacksSegmentAddress             00815000h           ; Virtual address of the .hacks segment
%define HacksSegmentOffset              005be000h           ; File offset of the .hacks segment
%define HacksSegmentSize                00002000h           ; Size of the .hacks segment


; Menu handler functions:
%define MenuHandler_MainMenu                            001B19BDh
%define MenuHandler_GamertagSelect                      002B43B8h

%define Create_MainMenu_Campaign                        002B47DDh
%define Create_XboxLive_Menu                            001B1A1Bh
%define Create_MainMenu_XboxLive                        002B47BAh
%define Create_MainMenu_SplitScreen                     002B4774h
%define Create_MainMenu_SystemLink                      002B4797h
%define Create_MainMenu_OptionsMenu                     001B17B3h

%define LoadScreen                                      000D75F8h
...
%define PrintDebugMessage                               000AC810h

%define CreateNetworkSquadBrowserScreen                 001B4A5Fh
...
%define get_transport_address                           00319DB0h

%define setsockopt                                      00454634h
%define GetLastError                                    0032EE69h
%define malloc                                          003A379Eh
%define free                                            003A5E1Dh
...
;-------------------------------------------------------------
    ...
    ;---------------------------------------------------------      
    dd          (001AA7B0h - ExecutableBaseAddress)
    ...
    ;---------------------------------------------------------      
    dd          (001B170Fh - ExecutableBaseAddress)
    dd          (_i_dont_agree_end - _i_dont_agree_start)
    _i_dont_agree_start:

            ; Skip the call.
            times (001B1716h - 001B170Fh) db 90h
    ...
    ;---------------------------------------------------------
    dd          (0x193407 - ExecutableBaseAddress) + 0x12
    ...
    ;---------------------------------------------------------
    dd          (002966FCh - ExecutableBaseAddress)
    ...
    ;---------------------------------------------------------
    dd          (0028A41Ch - ExecutableBaseAddress)
    ...
    ;---------------------------------------------------------
    dd          (0x31BFF6 - ExecutableBaseAddress)
    ...
    AddGameVariantMenuOptions_mid:
            times (0x31C03F - (0x31BFF6 + (AddGameVariantMenuOptions_mid - AddGameVariantMenuOptions_start))) db 0x90
...
%if ENABLE_DEBUG_OUTPUT != 0
    ...
    ; Patch log level
    ;---------------------------------------------------------      
    dd          (0014F20Fh - ExecutableBaseAddress)
    ...
    ;---------------------------------------------------------      
    dd          (0014ECC6h - ExecutableBaseAddress)
...
;-------------------------------------------------------------
    ...
    ;---------------------------------------------------------
    dd            (0x14B8D8 - ExecutableBaseAddress)
    ...
    ;---------------------------------------------------------
    dd            (0014B670h - ExecutableBaseAddress)
    ...
    ;---------------------------------------------------------
    dd            (001C6810h - ExecutableBaseAddress)
    ...
    ;---------------------------------------------------------
    dd          (001CE3A8h - ExecutableBaseAddress)
...
;---------------------------------------------------------
    ...
    _Hack_NetworkSquadListUpdate_Hook_done:
            ...
            mov     al, [006F16FCh]     ; Check which tick count to use
            test    al, al
